...
# Determine project root — supports both Docker (/app) and local dev environments.
_project_root = os.environ.get("PROJECT_ROOT") or (
    "/app" if os.path.isdir("/app") else os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
)
...
if __name__ == "__main__":
    bench_path = os.environ.get(
        "BENCHMARK_PATH",
        os.path.join(_project_root, "tests", "retrieval_benchmark.json"),
    )
